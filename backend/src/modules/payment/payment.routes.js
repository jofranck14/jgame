...
const { pay, confirm, verify, cancelVerify, getPayment, listPayments, updateProof } = require("./payment.controller");
...
router.post("/:id/cancel-verify", requireAuth, requireRole("admin"), cancelVerify);
